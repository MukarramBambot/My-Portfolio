        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Programmer | Game Developer | Visual Designer
              </motion.h2>
              ...
              >
                I create functional software solutions and visually engaging digital experiences.
                Passionate about combining programming logic with design thinking to build products that look as good as they work.
              </motion.p>
            ...
            >
              ...
              >
                <span className="text-accent-cyan text-sm font-medium">Creative Developer</span>
              </motion.div>
